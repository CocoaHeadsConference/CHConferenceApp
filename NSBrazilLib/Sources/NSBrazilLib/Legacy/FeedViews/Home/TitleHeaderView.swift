...
struct TitleHeaderView_Previews: PreviewProvider {
  static var previews: some View {
    TitleHeaderView(
      title: "Pra você que chegou até aqui:",
      subtitle:
        "Eu vou escrever um texto grande pra ocupar bastante espaço mas eu acho que tá tudo bem porque o texto é bem grande mesmo sabe"
    )
  }
}
